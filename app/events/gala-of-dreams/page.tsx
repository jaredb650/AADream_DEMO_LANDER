...
export default function EventGalaOfDreams() {
  const jsonLd = {
    ...
    "@type": "Event",
    "name": "Inaugural Gala of Dreams",
    "description": "Celebrating 5 years of impact. An evening of elegance and inspiration celebrating AAPI excellence at Glasshouse Chelsea.",
    "startDate": "2026-05-19T18:30:00-04:00",
    "endDate": "2026-05-19T23:00:00-04:00",
    ...
    "image": "https://asianamericandream.org/images/events/gala-of-dreams.jpg",
    "organizer": {
      "@type": "Organization",
      "name": "Asian American Dream",
    ...
    "offers": [
      {
        ...
        "price": "500",
        "priceCurrency": "USD",
        "url": "https://givebutter.com/c/galaofdreams",
      ...
      >
        ...
        <div className="rounded-2xl border border-[var(--color-light-gray)] overflow-hidden my-6">
          <table className="w-full">
            <caption className="sr-only">Ticket Tiers and Pricing</caption>
            <thead>
              <tr className="bg-[var(--color-off-white)]">
                <th scope="col" className="font-inter font-semibold text-xs tracking-wider uppercase text-[var(--color-deep-teal)] text-left px-5 py-3">Tier</th>
                <th scope="col" className="font-inter font-semibold text-xs tracking-wider uppercase text-[var(--color-deep-teal)] text-left px-5 py-3">Price</th>
                <th scope="col" className="font-inter font-semibold text-xs tracking-wider uppercase text-[var(--color-deep-teal)] text-left px-5 py-3">Impact</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-t border-[var(--color-light-gray)]">
                <td scope="row" className="font-inter font-medium text-sm text-[var(--color-charcoal)] px-5 py-3">Gala Ticket</td>
              ...
              <tr className="border-t border-[var(--color-light-gray)]">
                <td scope="row" className="font-inter font-medium text-sm text-[var(--color-charcoal)] px-5 py-3">Community Anchor</td>
              ...
              <tr className="border-t border-[var(--color-light-gray)]">
                <td scope="row" className="font-inter font-medium text-sm text-[var(--color-charcoal)] px-5 py-3">Impact Sponsor</td>
              ...
              <tr className="border-t border-[var(--color-light-gray)]">
                <td scope="row" className="font-inter font-medium text-sm text-[var(--color-charcoal)] px-5 py-3">Heritage Visionary</td>
